...
bundle exec rake test:tipit_mail_handler:unit
bundle exec rake test:tipit_mail_handler:functional
...
rm -rf vendor/plugins/chiliproject_tipit_mail_handler # Remove this plugin because it modifies default behaviour and brake tests

...
bundle exec rake test:clockability:$TEST_SUITE
...
rm -rf vendor/plugins/chiliproject_tipit_clockability # Remove this plugin because it modifies default behaviour and brake tests
